...
//        DisciplinaMatriculaEntity matricula = getById(id);
//
...
//
//        List<DisciplinaMatriculaEntity> list = repository.findAll().stream().filter(x -> x.getAluno()
...
//
//        List<DisciplinaMatriculaEntity> list = repository.buscaTodasPorDisciplinaPorId(idDisciplina);
//
//
